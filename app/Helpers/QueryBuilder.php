...
class QueryBuilder implements iQueryBuilder {
    ...
    public function insert() {
        if ( isset($this->queryObject) ) { throw new \Exception('Query has already been instantiated'); }
     ...
     * @inheritDoc
     */
    public function fullJoin(string $table, string $originField, string $targetField): \App\Interfaces\iSelectQuery {
        $this->queryObject->fullJoin($table, $originField, $targetField);
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function innerJoin(string $table, string $originField, string $targetField): \App\Interfaces\iSelectQuery {
        $this->queryObject->innerJoin($table, $originField, $targetField);
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function leftJoin(string $table, string $originField, string $targetField): \App\Interfaces\iSelectQuery {
        $this->queryObject->leftJoin($table, $originField, $targetField);
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function rightJoin(string $table, string $originField, string $targetField): \App\Interfaces\iSelectQuery {
        $this->queryObject->rightJoin($table, $originField, $targetField);
        return $this;
    }
     ...
     * @inheritDoc
     */
    public function setTable(string $table): \App\Interfaces\iQuery {
        $this->queryObject->setTable($table);
        return $this;
    }
